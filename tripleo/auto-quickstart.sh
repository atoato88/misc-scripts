...
bash quickstart.sh --release master --teardown all --tags all ${PARAM_CONFIG0} ${PARAM_EXTRA} -e @$CONFIG -p quickstart.yml $VIRTHOST 
if [[ $? -gt 0 ]]
then
  echo NG retry
...
bash ./tripleo-quickstart/quickstart.sh --release master --no-clone --teardown none --tags all ${PARAM_CONFIG} ${PARAM_EXTRA} -I -e @$CONFIG -p quickstart-extras-undercloud.yml $VIRTHOST 
...
bash ./tripleo-quickstart/quickstart.sh --release master --no-clone --teardown none --tags all ${PARAM_CONFIG} ${PARAM_EXTRA} -I -e @$CONFIG -p quickstart-extras-overcloud-prep.yml $VIRTHOST 
if [[ $? -gt 0 ]]
then
  echo NG retry
  #bash ./tripleo-quickstart/quickstart.sh -R master --no-clone --tags all ${PARAM_NODE} ${PARAM_CONFIG} ${PARAM_EXTRA} -I --teardown none -p quickstart-extras-overcloud-prep.yml 127.0.0.2
...
bash ./tripleo-quickstart/quickstart.sh --release master --no-clone --teardown none --tags all ${PARAM_CONFIG} ${PARAM_EXTRA} -I -e @$CONFIG -p quickstart-extras-overcloud.yml $VIRTHOST 
...
bash ./tripleo-quickstart/quickstart.sh --release master --no-clone --teardown none --tags all ${PARAM_CONFIG} ${PARAM_EXTRA} -I -e @$CONFIG -p quickstart-extras-validate.yml $VIRTHOST 
